...
function generateStringFromCharCode(code1, code2, code3, code4, code5) {
  let x =
    ...
    String.fromCharCode(code4) +
    String.fromCharCode(code5);
  return x;
}
...
function generateStringFromCodePoint(code1, code2, code3, code4) {
  let x =
    ...
    String.fromCodePoint(code3) +
    String.fromCodePoint(code4);
  return x;
}
...
function compareCharCodeAtAndCodePointAt(string, index) {
  ...
  return `charCodeAt:${charCodeAtResult}, codePointAt:${codePointAtResult},
  charAt:${charAtResult},at:${atResult}`;
}
